...
<head>
    ...
    <title>Pembayaran Perkuliahan</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="position-relative p-5 text-center text-muted bg-body border border-dashed rounded-5">
            <h1 class="text-body-emphasis">Payment Student with AJAX & jQuery</h1>
            <p class="col-lg-8 mx-auto mb-4">
                AJAX merupakan singkatan dari <b>A</b>synchronous <b>J</b>avascript <b>A</b>and <b>X</b>ML. AJAX
                berfungsi untuk:
            </p>
            <div class="container" style="width: 32rem;">
                <ul class="list-group list-group-flush m-4">
                    <li class="list-group-item list-group-item-action list-group-item-success">Mengambil data dari
                        server
                        secara background;</li>
                    <li class="list-group-item list-group-item-action list-group-item-success">Update tampilan web tanpa
                        harus relaod browser;</li>
                    <li class="list-group-item list-group-item-action list-group-item-success">Mengirim data ke server
                        secara background.</li>
                </ul>
            </div>
            <p class="col-lg-8 mx-auto mb-4">
                <b>JQUERY</b> adalah Javascript Library yang bisa dimanfaatkan untuk membuat applikasi web dengan cepat
                dimana
                Ajax adalah salah satu library dalam jquery.
            </p>
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#studentAddModal">
                Add Payment <i class="bi bi-plus-circle-fill"></i>
            </button>
        </div>
    </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <button type="button" value="<?= $student['id']; ?>"
                                            class="viewStudentBtn btn btn-info text-white fw-semibold btn-sm"><i
                                                class="bi bi-eye-fill"></i></button>
                                        <button type="button" value="<?= $student['id']; ?>"
                                            class="editStudentBtn btn btn-warning text-white fw-semibold btn-sm"><i
                                                class="bi bi-pencil-square"></i></button>
                                        <button type="button" value="<?= $student['id']; ?>"
                                            class="deleteStudentBtn btn btn-danger btn-sm fw-semibold"><i
